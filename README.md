...
│   Leaflet.js (карта)                        │
│                    │                        │
│   GET /api/air-quality (каждые 10 сек)      │
└────────────────────┬────────────────────────┘
                     │ HTTP
┌────────────────────▼────────────────────────┐
...
| Кеширование (30 сек)          | Снижение нагрузки/лимитов     |
...
| Технология            | Роль                                          |
| --------------------- | --------------------------------------------- |
| Vanilla JS (`fetch`)  | Запросы к бэкенду каждые 10 сек               |
...
- Уникальность: `(region_key, ts_hour)` — один набор на час
